...
function changeDescription(index) {
    ...
    switch (index) {
        ...
        case 2:
            ...
            break;
        case 3:
            descripcion.innerHTML = '<div class="description-content"><div><h2 class="titulo-desc-servicios-2">Servicio Destacado</h2><h3 class="titulo-desc-servicios">SEO</h3><p class="parrafo-desc-servicios text-muted">¡Un gran SEO aprovecha análisis poderosos y análisis de palabras clave para atraer tráfico local elegible al sitio web de su empresa, mejorar su potencial de ventas y convertirlo en una máquina de hacer dinero!</p><a href="#" class="btn-descripcion">Más información</a></div><img src="img/seoProto.png" alt="Imagen SEO"></div>';
            break;
        case 4:
            descripcion.innerHTML = '<div class="description-content-2"><div><h2 class="titulo-desc-servicios-2">Servicio Destacado</h2><h3 class="titulo-desc-servicios">Branding</h3><p class="parrafo-desc-servicios text-muted">Los clientes compran más, gastan más y defienden los productos en los que creen. Se necesita un enfoque integrado para producir resultados y crear una marca exitosa.<br>Diseccionamos las actividades de una marca desde todos los ángulos para encontrar diferencias y puntos de enlace para construir oportunidades, cambiar empresas y aumentar el alcance e impacto de nuestros clientes.</p><a href="#" class="btn-descripcion">Más información</a></div><img src="img/brandingProto.png" alt="Imagen Branding"></div>';
            break;
        case 5:
            descripcion.innerHTML = '<div class="description-content"><div><h2 class="titulo-desc-servicios-2">Servicio Destacado</h2><h3 class="titulo-desc-servicios">Desarrollo de Apps</h3><p class="parrafo-desc-servicios text-muted">Si su empresa requiere una solución personalizada, nuestro equipo está capacitado para diseñar un sitio web o una aplicación que satisfaga sus necesidades.</p><a href="#" class="btn-descripcion">Más información</a></div><img src="img/desarrolloAppsProto.png" alt="Imagen Desarrollo de Apps"></div>';
            break;
        default:
            descripcion.innerHTML = '<div class="description-content-2"><div><h2 class="titulo-desc-servicios-2">Servicio Destacado</h2><h3 class="titulo-desc-servicios">Pagina Web Empresarial</h3><p class="parrafo-desc-servicios text-muted">Si tu negocio aún no cuenta con un sitio web, entonces es hora de tener una presencia en línea que comunique la marca de tu empresa, así como que muestre información sobre servicios o productos.</p><a href="#" class="btn-descripcion">Más información</a></div><img src="img/desarrolloWebProto.png" alt="Imagen Desarrollo Web"></div>';
            break;
